...
initial begin
    ...
    // Open output files
    fid_out1 = $fopen("output_optimized_pipeline1_q214.txt","w");
    fid_out2 = $fopen("output_optimized_pipeline2_q214.txt","w");
    fid_out3 = $fopen("output_optimized_pipeline3_q214.txt","w");
